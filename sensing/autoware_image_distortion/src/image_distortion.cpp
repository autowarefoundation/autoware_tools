...
public:
    ImageDistortion() : Node("image_distortion") {
        ...
        RCLCPP_INFO(this->get_logger(), "Subscribing to: %s (Type: %s)", input_topic.c_str(), transport_type.c_str());

        sub_camera_ = image_transport::create_camera_subscription(
            this,
            input_topic,
            std::bind(&ImageDistortion::imageCallback, this, std::placeholders::_1, std::placeholders::_2),
            transport_type, 
