...
When embedding a fixed route from VMB, some routes may fail or produce incomplete centerline. Common causes and remedies:
...
| **InvalidLanelet**               | Start/goal lanelet has no valid centerline (e.g. centerline has fewer than 2 points).                             | Fix or regenerate the map so that lanelets have valid centerline.                                                                                                                               |
