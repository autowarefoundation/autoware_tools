...
* refactor(rtc_replayer): prefix rtc replayer (`#37 <https://github.com/sasakisasaki/autoware_tools/issues/37>`_)
  * feat(rtc_reaplyer): add rtc_replayer (`#1993 <https://github.com/sasakisasaki/autoware_tools/issues/1993>`_)
  ...
  * feat(rtc_auto_mode_manager): eliminate rtc auto mode manager (`#5235 <https://github.com/sasakisasaki/autoware_tools/issues/5235>`_)
