...
class SimjulatedAnnealing:
    ...
    def objective_function(self, param):
        ...
        # planner_param.theta_size = int(param[0])
        ...
        return 10*unsuccess_rate + average_length_rate + 1/2 * average_forward_backward_change
    ...
    def simulated_annealing(self, initial_param, initial_temperature, iterations, weight):
        ...
        for t in tqdm(range(iterations)):
            ...
            neighbor_param = current_param + weight * np.random.uniform(-1, 1, 3) # Small random change
            ...
            if neighbor_energy < current_energy or random.random() < math.exp((current_energy - neighbor_energy) / temperature):
                ...
                if neighbor_energy < best_energy:
                    ...
                    print("Objective value:", best_energy)
...
if __name__ == "__main__":
    ...
    best_param, best_energy = simulated_annealing.simulated_annealing(initial_param, initial_temperature, iterations, weight)
