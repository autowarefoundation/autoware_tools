...
* style: update rviz plugin icons to match the theme (`#117 <https://github.com/sasakisasaki/autoware_tools/issues/117>`_)
* feat: wait until autonomous mode is enabled (`#74 <https://github.com/sasakisasaki/autoware_tools/issues/74>`_)
