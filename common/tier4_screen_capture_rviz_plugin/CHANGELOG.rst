...
* feat: use new srv to capture screen shot and movie (`#121 <https://github.com/sasakisasaki/autoware_tools/issues/121>`_)
  * feat: add new type srv
  * feat: use new type srv
  * fix: remove unused process
  * fix: don't apply linter check for idl files
  ---------
* feat(tier4_screen_capture_rviz_plugin): add video capture with buffer functionality (`#80 <https://github.com/sasakisasaki/autoware_tools/issues/80>`_)
